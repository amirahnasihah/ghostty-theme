...
const float FADE_ENABLED = 1.0;   // fade gradient along the trail
const float FADE_EXPONENT = 2.5;  // lower = softer fade (original default is 5.0)
